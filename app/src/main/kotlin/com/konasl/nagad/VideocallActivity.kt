...
class VideocallActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        content.addView(text("ভিডিও কল", 20f, Typeface.BOLD, Color.WHITE))
        ...
        content.addView(text("ভিডিও কল ফিচারটি শীঘ্রই যুক্ত করা হবে।", 12.5f, Typeface.NORMAL, colorTextMuted).apply {
